    ...
    <table class="min-w-full divide-y divide-gray-200">
        ...
        <tbody class="bg-white divide-y divide-gray-200">
            ...
            <tr>
                ...
                @if($isAddingDiscountAndTax)
                <td class="px-6 py-4 whitespace-nowrap">
                    <select wire:model.live="returnItems.{{ $index }}.discount_type" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-sm">
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                    <input type="number" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-sm" 
                        wire:model.live="returnItems.{{ $index }}.discount" value="{{ $item['discount'] ?? 0 }}">
