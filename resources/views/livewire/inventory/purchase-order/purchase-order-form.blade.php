<div>
    <form wire:submit.prevent="submitOrder">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-4 p-4">
            ...
            <div>
                <label for="requestDate" class="block text-sm font-medium text-gray-700 mb-1">PO Number</label>
                <input type="text" id="RequestDate" wire:model.live="po_number" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
            ...
            <div>
                ...
                <select id="customer" wire:model.live="vendor_id" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
        ...
        <div class="mt-8">            
            <div class="mt-8 overflow-x-auto">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <select wire:model="purchaseOrderItems.{{ $index }}.product_id" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-sm"
                                >
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <input type="number" wire:model.live="purchaseOrderItems.{{ $index }}.quantity" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-sm">
                ...
                <div class="mt-2 px-6">
                    <button type="button" class="inline-flex items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" wire:click="addItem">
