 ...
 <div class="p-8">
    <div class="bg-white rounded-lg p-6 shadow-sm">
        <div class="flex justify-between items-center p-4 border-b">
            <h4 class="font-medium text-gray-700">Product Edit</h4>
        ...
        <form action="{{ route('products.update', $product->id) }}" method="POST" class="mt-4">
            ...
            <div class="p-4">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <x-input label="Product Code" name="product_code" :value="$product->product_code"/>                 
                    <div>
                    ...
                    <x-input label="MRP" name="mrp" type="number"  :value="$product->mrp"/>
                    <x-input label="Selling Price" name="selling_price" type="number" :value="$product->selling_price" />
                    <x-input label="GST %" name="gst_percentage" type="number" :value="$product->gst_percentage" />
                    <x-textarea label="Description" name="description" :value="$product->description" />
                </div>
