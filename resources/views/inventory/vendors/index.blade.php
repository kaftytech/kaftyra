 ...
 <div class="p-8">
    <div class="bg-white rounded-lg p-6 shadow-sm">
        <div class="flex justify-between items-center p-4 border-b">
            <h4 class="font-medium text-gray-700">Vendors</h4>
            <div class="flex space-x-2">
              <form id="importForm" action="{{ route('vendors.import') }}" method="POST" enctype="multipart/form-data" style="display: inline;">
                @csrf
        ...
        <!-- Table -->
        @livewire('inventory.vendor-table')
    </div>
 </div>
@endsection
